...
public class dashboardFragment extends Fragment {
    ...
    private Button veryHappyDialogButton;
    private Button happyDialogButton;
    private Button okayDialogButton;
...
//OnViewCreated method
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //IRRELEVANT/USELESS
        veryHappyBtn = view.findViewById(R.id.veryHappy_btn);
...
//initializing UI elements
        veryHappyCard = view.findViewById(R.id.homeveryHappyCard);
        happyCard = view.findViewById(R.id.hookayappyCard);
        okayCard = view.findViewById(R.id.homeokayCard);
        ...
        angryCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                handler.postDelayed(new Runnable() {
                    public void run() {
                        Intent intent = new Intent(getActivity(), createMoodEntry.class);
